...
# Git tag
#-----------------------------------------------------------------------------
set(EXTENSIONS_TRACK_QUALIFIER "4.1.1") # "master", 4.1, ...
...
set(Slicer_DIR "${CTEST_DASHBOARD_ROOT}/../Package/Slicer-411-package/Slicer-build")
...
set(CTEST_BINARY_DIRECTORY "${CTEST_DASHBOARD_ROOT}/SlicerExtensions-411-build-${dir_suffix}${testing_suffix}-${EXTENSIONS_TRACK_QUALIFIER}")

#-----------------------------------------------------------------------------
# Source directories
#-----------------------------------------------------------------------------
set(EXTENSIONS_BUILDSYSTEM_SOURCE_DIRECTORY "${CTEST_DASHBOARD_ROOT}/../Package/Slicer-411/Extensions/CMake")
...
#
set(url http://svn.slicer.org/Slicer4/branches/Slicer-4-1-1/Extensions/CMake/SlicerExtensionsDashboardDriverScript.cmake)
