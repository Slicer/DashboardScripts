...
set(Slicer_DIR "${CTEST_DASHBOARD_ROOT}/../Package/Slicer-421-package/Slicer-build")
...
set(CTEST_BINARY_DIRECTORY "${CTEST_DASHBOARD_ROOT}/SlicerExtensions-421-build-${dir_suffix}${testing_suffix}-${EXTENSIONS_TRACK_QUALIFIER}")

#-----------------------------------------------------------------------------
# Source directories
#-----------------------------------------------------------------------------
set(EXTENSIONS_BUILDSYSTEM_SOURCE_DIRECTORY "${CTEST_DASHBOARD_ROOT}/../Package/Slicer-421/Extensions/CMake")
