...
REM "C:\D\Support\CMake 3.0.1\bin\ctest.exe" -S "C:\D\DashboardScripts\factory-south-win7-vs2008-32bits_slicerextensions_testing_release_nightly.cmake" -C Release -VV -O C:\D\Logs\factory-south-win7-vs2008-32bits_slicerextensions_testing_release_nightly.txt

REM Nightly build of slicer extensions vs2008 32bits
REM "C:\D\Support\CMake 3.0.1\bin\ctest.exe" -S "C:\D\DashboardScripts\factory-south-win7-vs2008-32bits_slicerextensions_release_nightly.cmake" -C Release -VV -O C:\D\Logs\factory-south-win7-vs2008-32bits_slicerextensions_release_nightly.txt

REM Nightly build of slicer 4.1.1 extensions vs2008 32bits
REM "C:\D\Support\CMake 3.0.1\bin\ctest.exe" -S "C:\D\DashboardScripts\factory-south-win7-vs2008-32bits_slicerextensions_411_release_nightly.cmake" -C Release -VV -O C:\D\Logs\factory-south-win7-vs2008-32bits_slicerextensions_411_release_nightly.txt

REM Nightly build of slicer 4.3 extensions vs2008 32bits
REM "C:\D\Support\CMake 3.0.1\bin\ctest.exe" -S "C:\D\DashboardScripts\factory-south-win7-vs2008-32bits_slicerextensions_43_release_nightly.cmake" -C Release -VV -O C:\D\Logs\factory-south-win7-vs2008-32bits_slicerextensions_43_release_nightly.txt
...
REM "C:\D\Support\CMake 3.0.1\bin\ctest.exe" -S "C:\D\DashboardScripts\factory-south-win7-vs2010-32bits_slicer4_release_nightly.cmake" -C Release -V -O C:\D\Logs\factory-south-win7-vs2010-32bits_slicer4_release_nightly.txt

REM Nightly build of CTKAppLauncher vs2008 32bits
REM "C:\D\Support\CMake 3.0.1\bin\ctest.exe" -S "C:\D\DashboardScripts\factory-south-win7-vs2008-32bits_CTKAppLauncher_release_nightly.cmake" -C Release -VV -O C:\D\Logs\factory-south-win7-vs2008-32bits_CTKAppLauncher_release_nightly.txt
