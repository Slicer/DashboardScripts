...
REM "C:\D\Support\CMake 2.8.10.2\bin\ctest.exe" -S "C:\D\DashboardScripts\factory-south-win7-vs2008-32bits_slicer4-itkv4_release_nightly.cmake" -C Release -V -O C:\D\Logs\factory-south-win7-vs2008-32bits_slicer4-itkv4_release_nightly.txt
