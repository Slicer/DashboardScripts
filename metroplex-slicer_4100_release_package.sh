...
time /home/kitware/bin/slicer-buildenv-qt5-centos7-slicer-410 \
  --args "${docker_args}" \
  ctest -S /work/DashboardScripts/metroplex-slicer_4100_release_package.cmake -VV -O /work/Logs/metroplex-slicer_4100_release_package.log
