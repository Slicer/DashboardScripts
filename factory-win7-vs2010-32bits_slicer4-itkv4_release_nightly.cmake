...
set(MY_COMPILER           "VS2010")
set(MY_QT_VERSION         "4.7.1")
set(CTEST_DASHBOARD_ROOT  "C:/D/N")
set(QT_QMAKE_EXECUTABLE   "C:/Dashboards/Support/qt-everywhere-opensource-src-4.7.1/bin/qmake.exe")
...
#
set(CTEST_SOURCE_DIRECTORY "${CTEST_DASHBOARD_ROOT}/Slicer-6")
#set(CTEST_BINARY_DIRECTORY "${CTEST_DASHBOARD_ROOT}/Slicer-build-${BUILD_OPTIONS_STRING}-${CTEST_BUILD_CONFIGURATION}-${SCRIPT_MODE}")
set(CTEST_BINARY_DIRECTORY "${CTEST_DASHBOARD_ROOT}/Slicer-6-build")

file(WRITE "${CTEST_DASHBOARD_ROOT}/Slicer-6-build - Slicer-build-${BUILD_OPTIONS_STRING}-${CTEST_BUILD_CONFIGURATION}-${SCRIPT_MODE}.txt" "Generated by ${CTEST_SCRIPT_NAME}")
