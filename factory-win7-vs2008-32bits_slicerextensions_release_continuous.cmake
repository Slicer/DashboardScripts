...
#set(Slicer_DIR "${CTEST_DASHBOARD_ROOT}/../N/Slicer-build-${dir_suffix}-nightly/Slicer-build")
set(Slicer_DIR "${CTEST_DASHBOARD_ROOT}/../N/Slicer-0-build/Slicer-build")
...
set(CTEST_BINARY_DIRECTORY "${CTEST_DASHBOARD_ROOT}/S-0-E${testing_suffix}-b")
file(WRITE "${CTEST_DASHBOARD_ROOT}/S-0-E${testing_suffix}-b - SlicerExtensions-build-${dir_suffix}-${SCRIPT_MODE}${testing_suffix}-${EXTENSIONS_TRACK_QUALIFIER}.txt" "Generated by ${CTEST_SCRIPT_NAME}")

#-----------------------------------------------------------------------------
# Source directories
#-----------------------------------------------------------------------------
set(EXTENSIONS_BUILDSYSTEM_SOURCE_DIRECTORY "${CTEST_DASHBOARD_ROOT}/Slicer-0/Extensions/CMake")
