...
/Applications/CMake\ 2.8-12.app/Contents/bin/ctest -S $DASHBOARD_SCRIPTS_DIR/${HOSTNAME}-64bits_slicer4_release_package.cmake -VV -O $LOG_DIR/${HOSTNAME}-64bits_slicer4_release_package.txt
