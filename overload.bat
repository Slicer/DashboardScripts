...
"C:\cmake-3.13.4\bin\ctest.exe" -S "D:\D\DashboardScripts\overload-vs2017-slicersalt_preview_nightly.cmake" -C Release -VV -O D:\D\Logs\overload-vs2017-slicersalt_preview_nightly.txt
