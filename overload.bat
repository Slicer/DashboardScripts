...
"C:\cmake-3.13.4\bin\ctest.exe" -S "D:\D\DashboardScripts\overload-vs2015-slicer_preview_nightly.cmake" -C Release -VV -O D:\D\Logs\overload-vs2015-slicer_preview_nightly.txt

:: ----------------------------------------------------------------------------
:: Build Slicer Extensions
:: ----------------------------------------------------------------------------
call :fastdel "D:\D\P\S-0-E-b"
call :fastdel "D:\D\S\S-4102-E-b"
if "%IS_WEEKEND%"=="1" (
...
"C:\cmake-3.13.4\bin\ctest.exe" -S "D:\D\DashboardScripts\overload-vs2015-slicerextensions_preview_nightly.cmake" -C Release -VV -O D:\D\Logs\overload-vs2015-slicerextensions_preview_nightly.txt
EXIT /B 0

:: ----------------------------------------------------------------------------
:slicerextensions_stable_nightly
::echo "Slicer 'Stable' release extensions"
"C:\cmake-3.13.4\bin\ctest.exe" -S "D:\D\DashboardScripts\overload-vs2015-slicerextensions_stable_nightly.cmake" -C Release -VV -O D:\D\Logs\overload-vs2015-slicerextensions_stable_nightly.txt
EXIT /B 0
