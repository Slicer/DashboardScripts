...
#-----------------------------------------------------------------------------
set(HOSTNAME              "factory-south-macosx")
set(MY_QT_VERSION         "5.7.1")
set(CTEST_DASHBOARD_ROOT  "/Volumes/Dashboards/Dashboards/${SCRIPT_MODE}")

set(SVN_BRANCH "trunk")
set(SVN_REVISION "")

# XXX: Temporary Qt5/VTK8 branch
set(GIT_REPOSITORY "git://github.com/msmolens/Slicer.git")
set(GIT_TAG "support-qt5-2017-08-05-r26208")
...
#set(DOCUMENTATION_ARCHIVES_OUTPUT_DIRECTORY ) # for example: /Volumes/Dashboards/Projects/Doxygen
...
# Configure Options
#-----------------------------------------------------------------------------
set(CTEST_CONFIGURE_OPTIONS "-DQt5_DIR:PATH=${Qt5_DIR}")
...
set(url https://raw.githubusercontent.com/msmolens/Slicer/${GIT_TAG}/CMake/SlicerDashboardDriverScript.cmake)
