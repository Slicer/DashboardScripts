...
/Volumes/Dashboards/Support/CMake-3.12.2.app/Contents/bin/ctest -S /Volumes/Dashboards/DashboardScripts/factory-south-macos-slicer_4102_release_package.cmake -VV -O /Volumes/Dashboards/Logs/factory-south-macos-slicer_4102_release_package.log
