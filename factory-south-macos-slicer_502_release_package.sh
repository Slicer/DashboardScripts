...
/Volumes/D/Support/CMake-3.22.1.app/Contents/bin/ctest -S /Volumes/D/DashboardScripts/factory-south-macos-slicer_502_release_package.cmake -VV -O /Volumes/D/Logs/factory-south-macos-slicer_502_release_package.log
